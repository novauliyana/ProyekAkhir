                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive pt-3">
                            <form class="forms-sample" method="POST" action="<?= base_url('elearningguru/updatenilaikuis/') . $this->uri->segment('3') . '/' . $this->uri->segment('4') ?>">
