                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive pt-3">
                            <form class="forms-sample" method="POST" action="<?= base_url('elearningguru/updatenilaitugas/') . $this->uri->segment('4') ?>">
                                    ...
                                    foreach ($nilaitugas as $sia) : ?>
                                        <tbody>
                                            <tr>
                                                ...
                                                <input type="hidden" name="idtugas" value="<?= $sia['id_tugas'] ?>">
