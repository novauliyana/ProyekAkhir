    ...
    <div class="container-fluid page-body-wrapper">
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <ul class="nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url('elearningguru/index') ?>">
                        <i class="mdi mdi-home menu-icon"></i>
                        <span class="menu-title">Profile</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url('elearningguru/notification') ?>">
                        <i class="mdi mdi-timetable menu-icon"></i>
                        <span class="menu-title">Aktivitas Terbaru</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url('elearningguru/class') ?>">
