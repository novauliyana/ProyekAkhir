                        ...
                        <div class="card-body">
                            ...
                            <table>
                                <tr height="50">
                                    ...
                                    <td width="300">Materi dan Video Pembelajaran</td>
                                    <td align="right" width="200"><?php echo anchor('elearningsiswa/materi/' . $sia['id_mapel'], '<div class="btn btn-success btn-sm">Buka</div>') ?></td>

                                    <td width="50"></td>
                                    <td width="50"><i class="mdi mdi-pencil mr-3 icon-md text-warning"></i></td>
                                    <td width="300">Kuis</td>
                                    <td align="right" width="200"><?php echo anchor('elearningsiswa/kuis/' . $sia['id_mapel'], '<div class="btn btn-success btn-sm">Buka</div>') ?></td>
                                </tr>
                                <tr height="50">
                                    <td width="50"><i class="mdi  mdi-file-document-box mr-3 icon-md text-info"></td>
                                    <td width="300">Tugas</td>
                                    <td align="right" width="200"><?php echo anchor('elearningsiswa/tugas/' . $sia['id_mapel'], '<div class="btn btn-success btn-sm">Buka</div>') ?></td>
                                    <td width="50"></td>
                                    <td width="50"><i class="mdi mdi-pen mr-3 icon-md text-success"></td>
                                    <td width="300">Ulangan</td>
                                    <td align="right" width="200"><?php echo anchor('elearningsiswa/ulangan/' . $sia['id_mapel'], '<div class="btn btn-success btn-sm">Buka</div>') ?></td>
                                </tr>
