                ...
                <div class="card">
                    <div class="card-body">
                        <blockquote class="blockquote">
                            <form class="forms-sample" method="POST" action="<?= base_url('elearningsiswa/submit_kuis') ?>" enctype="multipart/form-data">
                                <table width="100%">
                                    <?php foreach ($kuis as $sia) : ?>
                                        <tr>
                                            <td width="150">
                                                <h5 class="card-text"><?= $sia['judul_kuis'] ?></h5><br>
                                                <input type="hidden" name="id_mapel" class="form-control" value="<?= $sia['id_mapel'] ?>">
                                                <input type="hidden" name="id_kuis" class="form-control" value="<?= $sia['id_kuis'] ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table>
                            ...
                            <tr>
                                <td colspan="2">
                                    <p><strong>Deskripsi Kuis: </strong></p>
