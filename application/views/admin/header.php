    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="navbar-brand-wrapper d-flex justify-content-center">
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">  
          <a class="navbar-link text-white" href="<?= base_url('admin/index')?>">SMA PRESTASI PRIMA</a>
          <a class="navbar-brand brand-logo-mini" href="<?= base_url('admin/index') ?>"><img src="<?= base_url('images/logo-mini.svg');?>" alt="logo"/></a>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="<?= base_url('admin/datasiswa');?>">Lihat Data Siswa</a></li>
                <li class="nav-item"> <a class="nav-link" href="<?= base_url('admin/tambahdatasiswa');?>">Tambah Data Siswa</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="auth">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="<?= base_url('admin/dataguru');?>">Lihat data guru</a></li>
                <li class="nav-item"> <a class="nav-link" href="<?= base_url('admin/tambahdataguru');?>">Tambah data guru </a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
