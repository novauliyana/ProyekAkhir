        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr>
                    <form class="forms-sample" method="POST" action="<?= base_url('Home') ?>" enctype="multipart/form-data">
                        <blockquote class="blockquote">
                            <table width="100%">
                                <?php foreach ($materi as $sia) : ?>
                                    ...
                                    <tr>
                                        <td align="right"><a href="<?= base_url('Home/tugas') ?>"><button type="submit" class="btn btn-success mr-2" value="" colspan="2"> Submit</button></a></td>
                                    </tr>
                                <?php endforeach;  ?>
                            </table>
                        </blockquote>
