                ...
                <div class="card">
                    <div class="card-body">
                        <?php foreach ($as as $tmp) : ?>
                            ...
                            <form class="pt-3" method="POST" action="<?= base_url('siswa/upload_berkas'); ?>" enctype="multipart/form-data">
                                <?= $this->session->flashdata('message'); ?>
                                <div class="form-group">
                                    <label>Kartu Keluarga</label>
                                    <?php echo form_open_multipart('siswa/do_upload'); ?>
                                    <div class="input-group col-xs-12">
                                        <input class="form-control" name="kartu_keluarga" type="text" value="<?= base_url() . $tmp->kartu_keluarga ?>" placeholder="">
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <img src="<?= base_url() . $tmp->kartu_keluarga ?>" alt="" width="200px" height="200px">
                                                </div>
                                                <!-- footer modal -->
                                ...
                                <div class="form-group">
                                    ...
                                    <?php echo form_open_multipart('siswa/do_upload'); ?>
                                    <div class="input-group col-xs-12">
                                        <input class="form-control" name="akte_kelahiran" type="text" value="<?= base_url() . $tmp->akte_kelahiran ?>" placeholder="">
                                        <span class="input-group-append">
                                    ...
                                    <div id="akte" class="modal fade" role="dialog">
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <!-- body modal -->
                                                <div class="modal-body">
                                                    <img src="<?= base_url() . $tmp->akte_kelahiran ?>" alt="" width="200px" height="200px">
                                                </div>
                                                <!-- footer modal -->
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php echo form_open_multipart('siswa/do_upload'); ?>
                                    <div class="input-group col-xs-12">
                                        <input class="form-control" name="ijazah" type="text" value="<?= base_url() . $tmp->ijazah ?>" placeholder="">
                                        <span class="input-group-append">
                                    ...
                                    <div id="ijazah" class="modal fade" role="dialog">
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <!-- body modal -->
                                                <div class="modal-body">
                                                    <img src="<?= base_url() . $tmp->ijazah ?>" alt="" width="200px" height="200px">
                                                </div>
                                                <!-- footer modal -->
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php echo form_open_multipart('siswa/do_upload'); ?>
                                    <div class="input-group col-xs-12">
                                        <input class="form-control" name="akte_kelahiran" type="text" value="<?= base_url() . $tmp->ktp_ortu ?>" placeholder="">
                                        <span class="input-group-append">
                                    ...
                                    <div id="ktportu" class="modal fade" role="dialog">
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <!-- body modal -->
                                                <div class="modal-body">
                                                    <img src="<?= base_url() . $tmp->ktp_ortu ?>" alt="" width="200px" height="200px">
                                                </div>
                                                <!-- footer modal -->
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
