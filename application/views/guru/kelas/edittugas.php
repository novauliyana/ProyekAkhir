            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php foreach ($tugas as $materi) : ?>
                            <form class="forms-sample" method="POST" action="<?= base_url('guru/edit_tugas/'  . $this->uri->segment('3') . '/' . $this->uri->segment('4')); ?> " enctype="multipart/form-data">

                                <div class="form-group">
                                    <input type="hidden" class="form-control" name="id_mapel" value="<?= $this->uri->segment('4') ?>">
                                    <input type="hidden" name="id_tugas" value="<?= $materi['id_tugas']; ?>">
                                    <label for="exampleInputName1">Judul</label>
                                    <input type="text" class="form-control" name="judul_tugas" placeholder="Judul" value="<?= $materi['judul_tugas']; ?>">
