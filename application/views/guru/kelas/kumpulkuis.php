            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p>
                            <strong>
                                <?php foreach ($jumlahkumpulkuis as $jm) : ?>
                                    <?= $jm->jmlhkumpulkuis; ?> Pengumpulan
                                    ...
                                    foreach ($kumpulkuis as $sia) : ?>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td width="140"><?php echo anchor('guru/editnilaikuis/' . $sia['id'], '<div class="btn btn-inverse-warning btn-sm"><i class="mdi mdi-pencil"></i></div>') ?>
